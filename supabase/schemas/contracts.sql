...
CREATE TABLE public.contracts_tenants(
  ...
  CONSTRAINT fk_contracts_tenants_contract_id FOREIGN KEY (contract_id) REFERENCES contracts(id) ON DELETE CASCADE,
  CONSTRAINT fk_contracts_tenants_tenant_id FOREIGN KEY (tenant_id) REFERENCES tenants(id) ON DELETE CASCADE
);
...
CREATE TABLE public.due_notes(
  ...
  CONSTRAINT fk_due_notes_contract_id FOREIGN KEY (contract_id) REFERENCES contracts(id) ON DELETE CASCADE
);
...
CREATE TABLE public.renting_contracts(
  ...
  CONSTRAINT fk_renting_contracts_id_contract_type FOREIGN KEY (id, contract_type) REFERENCES contracts(id, type) ON DELETE CASCADE
);
...
CREATE TABLE public.rent_payments(
  ...
  CONSTRAINT fk_rent_payments_contract_id FOREIGN KEY (contract_id) REFERENCES renting_contracts(id) ON DELETE CASCADE,
  CONSTRAINT fk_rent_payments_movement_id FOREIGN KEY (movement_id) REFERENCES movements(id)
);
...
CREATE TABLE public.lending_contracts(
  ...
  CONSTRAINT fk_lending_contracts_id_contract_type FOREIGN KEY (id, contract_type) REFERENCES contracts(id, type) ON DELETE CASCADE
);
...
CREATE TABLE public.installment_payments(
  ...
  CONSTRAINT fk_installment_payments_contract_id FOREIGN KEY (contract_id) REFERENCES lending_contracts(id) ON DELETE CASCADE,
  CONSTRAINT fk_installment_payments_interest_movement_id FOREIGN KEY (interest_movement_id) REFERENCES movements(id),
  CONSTRAINT fk_installment_payments_amortization_movement_id FOREIGN KEY (amortization_movement_id) REFERENCES movements(id)
);
