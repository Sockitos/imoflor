<script lang="ts">
	...
	export let form: SuperValidated<CreateVendorSchema> | SuperValidated<UpdateVendorSchema>;
...
<Form.Root
	method="POST"
	action={editing ? '/vendors?/update' : '/vendors?/create'}
	controlled
	form={sForm}
	schema={editing ? updateVendorSchema : createVendorSchema}
	let:config
>
	<div class="space-y-4">
