<script lang="ts">
	...
	export let form: SuperValidated<CreateEmployeeSchema> | SuperValidated<UpdateEmployeeSchema>;
...
<Form.Root
	method="POST"
	action={editing ? '/employees?/update' : '/employees?/create'}
	controlled
	form={sForm}
	schema={editing ? updateEmployeeSchema : createEmployeeSchema}
	let:config
			...
			<Form.Field {config} name="mobile">
				<Form.Item>
					...
					<Form.Select>
						...
						<Form.SelectContent>
							<Form.SelectItem value="hourly">Hourly</Form.SelectItem>
							<Form.SelectItem value="monthly">Monthly</Form.SelectItem>
						</Form.SelectContent>
					</Form.Select>
					<Form.Validation />
				</Form.Item>
			</Form.Field><Form.Field {config} name="salary">
				<Form.Item>
